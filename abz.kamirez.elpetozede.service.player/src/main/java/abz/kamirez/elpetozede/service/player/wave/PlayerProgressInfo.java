...
public class PlayerProgressInfo extends ProgressInfo
{
  private int m_currentFrame;
  private boolean m_isFinished = false;

  public PlayerProgressInfo(IProgressReportingTask task, int percentage, String message)
  {
    super(task, percentage, message);
  }
